...
const TOUR_STEPS=[
  ...
  {page:'hub',target:'#aiFab',title:'Need Answers — Your First Call When Stuck',text:"Introduced now so you know it exists from day one. Ask anything: product rules, compliance questions, how a tool works. Available 24/7 — voice, text, or photo. Tap any time you're unsure.",pos:'top',phase:'Phase 1 of 7 — Know Your Obligations'},
  // ── Phase 2 — Learn the Playbook ───────────────────────────────────────────────
  {page:'replguide',target:null,title:'Smart Replacement Training Guide — Your Playbook',text:'The most important document on the hub. Every rule, risk, and script for replacement cases — from client engagement to file submission. Know this before taking any replacement appointment.',pos:'center',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s0',title:'§0 — Client Issues & Required Docs',text:'The 5 biggest problems at replacement: lopsided cover, data errors, unknown value, no servicing, affordability. Required docs before every appointment: 3-month bank statement, payslip, all competitor policy schedules.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s1',title:'§1 — The Win-Win Strategy',text:'How a proper replacement protects you (no clawbacks, no liability) and protects the client (accurate cover, correct beneficiaries). Includes the pre-appointment needs analysis checklist: real budget, funeral costs, sole vs shared responsibility.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s2',title:'§2 — Client Declaration Form',text:'The form every replacement case must have: Part A (affordability & QLink cap), Part B (policy reconciliation & insurable interest per life), Part C (all FAIS statutory disclosures). Must be signed on or before the capture date.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s3',title:'§3 — ROA Boilerplate Text',text:'The exact wording that goes into IMP for a replacement case. Copy, fill the blanks, paste. Using this template means your ROA meets compliance requirements every time and protects you in any dispute.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s7',title:'§7 — The Red Lines',text:'5 rules you must never break: no verbal agreements; blood vs clan/tribe name; active policies only; 15% cap is on Basic Salary not Gross; no backdating. Breaking these ends careers and triggers FSP sanctions.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replguide',target:'#rg-s8',title:'§8 — File Checklist — 4 Items Before You Submit',text:'Before submitting any replacement, your file must have all 4: competitor policy schedule, signed declaration form, completed ROA with boilerplate, and new policy application matching the declaration exactly. Missing one = non-compliant.',pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  {page:'replpresentation',target:'#replSlideContainer',title:'Client Prospect Presentation — 8 Steps to Close',text:"Conversation cue-card deck built from the guide's scripts. Slide 1 opens the conversation, Slide 8 closes it. Use this to rehearse your approach or present to a client group. Every slide tells you what to say.",pos:'bottom',phase:'Phase 2 of 7 — Learn the Playbook'},
  ...
  {page:'hub',target:'#hubTop3',title:'Leaderboard — Where You Rank',text:'Top 3 advisors by premium for the current production month, plus your own production card showing cases and premium vs target. Use this every morning to know exactly where you stand.',pos:'bottom',phase:'Phase 3 of 7 — Daily Starting Point'},
